...
func TestV1GetConfigAsJsonTrendS_JSON(t *testing.T) {
	var reply string
	expected := `{"trends":{"enabled":false,"stats_conns":[]}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJsonRANKINGS_JSON(t *testing.T) {
	var reply string
	expected := `{"rankings":{"enabled":false}}`
	cfgCgr := NewDefaultCGRConfig()
