...
"freeswitchAgent": {
	...
	{"address": "1.2.3.5:8021", "password": "ClueCon", "reconnects": 5, "replyTimeout": "30s", "alias":"124"}
	],
},
...
"httpAgent": [
	{
		...
		"requestPayload":	"*url",			// source of input data <*url>
		"replyPayload":	"*xml",			// type of output data <*xml>
		"requestProcessors": [],
	}
],
}
...
func TestCgrCfgJSONDefaultsDiameterAgentCfg(t *testing.T) {
	testDA := &DiameterAgentCfg{
		...
		Listeners: []DiameterListener{
			{Address: "127.0.0.1:3868", Network: utils.TCP},
		},
	...
	if !reflect.DeepEqual(cgrCfg.diameterAgentCfg.Listeners, testDA.Listeners) {
		t.Errorf("expecting: %+v, received: %+v", cgrCfg.diameterAgentCfg.Listeners, testDA.Listeners)
	}
...
func TestLoadGeneralCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal array into Go struct field GeneralJsonCfg.nodeID of type string"
...
"caches":{
	...
	expected := "json: cannot unmarshal number into Go struct field CacheJsonCfg.replicationConns of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadListenCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal number into Go struct field ListenJsonCfg.httpTLS of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadHTTPCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field HTTPJsonCfg.authUsers of type map[string]string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
"db": {
	...
	expected := "json: cannot unmarshal number into Go struct field DbConnJson.dbConns.dbHost of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadDiameterAgentCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal number into Go struct field ReqProcessorJsnCfg.requestProcessors.ID of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
"radiusAgent": {
	...
	expected := "json: cannot unmarshal number into Go struct field RadiusListenerJsonCfg.listeners.authAddress of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadChargerSCfgError(t *testing.T) {
	cfgJSONStr := `{
	"chargers": {
		"prefixIndexedFields": "prefix",	
	},	
}`
	expected := "json: cannot unmarshal string into Go struct field ChargerSJsonCfg.prefixIndexedFields of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadResourceSCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field ResourceSJsonCfg.stringIndexedFields of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadStatSCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field StatServJsonCfg.stringIndexedFields of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadThresholdSCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal number into Go struct field ThresholdSJsonCfg.storeInterval of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadLoaderSCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal number into Go struct field LoaderJsonCfg.runDelay of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadRouteSCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field RouteSJsonCfg.stringIndexedFields of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadSureTaxCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal number into Go struct field SureTaxJsonCfg.salesTypeCode of type string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadLoaderCgrCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field LoaderCfgJson.cachesConns of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadMigratorCgrCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field MigratorCfgJson.usersFilters of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadTlsCgrCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field TlsJsonCfg.serverPolicy of type int"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
...
func TestLoadRateSCfgError(t *testing.T) {
	cfgJSONStr := `{
     "rates": {
	         "stringIndexedFields": "*req.index",
     },
}`
	expected := "json: cannot unmarshal string into Go struct field RateSJsonCfg.stringIndexedFields of type []string"
	cgrConfig := NewDefaultCGRConfig()
	if cgrCfgJSON, err := NewCgrJsonCfgFromBytes([]byte(cfgJSONStr)); err != nil {
		t.Error(err)
	...
	expected := LoaderSCfgs{
		{
			...
			Conns:          map[string][]*DynamicConns{utils.MetaCaches: {{ConnIDs: []string{utils.ConcatenatedKey(utils.MetaInternal, utils.MetaCaches)}}}},
			FieldSeparator: ",",
		...
		Readers: []*EventReaderCfg{
			{
				...
				Opts: &EventReaderOpts{
					...
					NATSSubject:         utils.StringPointer("cgratesCDRs"),
				},
			},
		},
		...
		LoaderSJSON: []map[string]any{
			{
				...
				utils.ConnsCfg:        map[string][]*DynamicConns{utils.MetaCaches: {{ConnIDs: []string{utils.MetaInternal}}}},
				utils.FieldSepCfg:     ",",
...
"listen": {
	...
	expected := map[string]any{
		"listen": map[string]any{
			"http":       ":2080",
			"httpTLS":    "127.0.0.1:2280",
			"rpcGOB":     ":2013",
			"rpcGOBtls":  "127.0.0.1:2023",
			"rpcJSON":    ":2012",
			"rpcJSONtls": "127.0.0.1:2022",
		},
	}
	var rcv map[string]any
	if cgrCfg, err := NewCGRConfigFromJSONStringWithDefaults(jsnCfg); err != nil {
	...
	expected := map[string]any{
		DiameterAgentJSON: map[string]any{
			...
			utils.ListenersCfg: []map[string]any{
				{utils.AddressCfg: "127.0.0.1:3868", utils.NetworkCfg: "tcp"},
			},
...
func TestV1GetConfigAsJSONGeneral(t *testing.T) {
	...
	expected := `{"general":{"cachingDelay":"0","connectAttempts":5,"connectTimeout":"1s","dbDataEncoding":"*msgpack","decimalMaxScale":0,"decimalMinScale":0,"decimalPrecision":0,"decimalRoundingMode":"*toNearestEven","defaultCaching":"*reload","defaultCategory":"call","defaultRequestType":"*rated","defaultTenant":"cgrates.org","defaultTimezone":"Local","digestEqual":":","digestSeparator":",","lockingTimeout":"0","maxParallelConns":100,"maxReconnectInterval":"0","nodeID":"ENGINE1","opts":{"*exporterIDs":[]},"reconnects":-1,"replyTimeout":"2s","roundingDecimals":5,"tpExportDir":"/var/spool/cgrates/tpe"}}`
...
func TestV1GetConfigAsJSONTls(t *testing.T) {
	var reply string
	expected := `{"tls":{"caCertificate":"","clientCertificate":"","clientKey":"","serverCertificate":"","serverKey":"","serverName":"","serverPolicy":4}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONTListen(t *testing.T) {
	var reply string
	expected := `{"listen":{"http":"127.0.0.1:2080","httpTLS":"127.0.0.1:2280","rpcGOB":"127.0.0.1:2013","rpcGOBtls":"127.0.0.1:2023","rpcJSON":"127.0.0.1:2012","rpcJSONtls":"127.0.0.1:2022"}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONAccounts(t *testing.T) {
	var reply string
	expected := `{"accounts":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"maxIterations":1000,"maxUsage":"259200000000000","nestedFields":false,"notExistsIndexedFields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*usage":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"suffixIndexedFields":[]}}`
	cfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONSessionS(t *testing.T) {
	var reply string
	expected := `{"sessions":{"alterableFields":[],"channelSyncInterval":"0","clientProtocol":1,"conns":{},"defaultUsage":{"*any":"3h0m0s","*data":"1048576","*sms":"1","*voice":"3h0m0s"},"enabled":false,"listenBiGob":"","listenBiJSON":"127.0.0.1:2014","minDurLowBalance":"0","opts":{"*accounts":[{"filterIDs":null,"tenant":""}],"*accountsForceUsage":[],"*attributes":[{"filterIDs":null,"tenant":""}],"*attributesDerivedReply":[{"filterIDs":null,"tenant":""}],"*autoChargeInterval":[{"filterIDs":null,"tenant":""}],"*blockerError":[{"filterIDs":null,"tenant":""}],"*cdrs":[{"filterIDs":null,"tenant":""}],"*cdrsDerivedReply":[{"filterIDs":null,"tenant":""}],"*chargeable":[{"filterIDs":null,"tenant":""}],"*chargers":[{"filterIDs":null,"tenant":""}],"*ees":[],"*eesIDs":[],"*forceUsage":[],"*initiate":[{"filterIDs":null,"tenant":""}],"*ips":[{"filterIDs":null,"tenant":""}],"*ipsAllocate":[{"filterIDs":null,"tenant":""}],"*ipsAuthorize":[{"filterIDs":null,"tenant":""}],"*ipsRelease":[{"filterIDs":null,"tenant":""}],"*maxUsage":[{"filterIDs":null,"tenant":""}],"*message":[{"filterIDs":null,"tenant":""}],"*originID":[],"*rates":[{"filterIDs":null,"tenant":""}],"*resources":[{"filterIDs":null,"tenant":""}],"*resourcesAllocate":[{"filterIDs":null,"tenant":""}],"*resourcesAuthorize":[{"filterIDs":null,"tenant":""}],"*resourcesDerivedReply":[{"filterIDs":null,"tenant":""}],"*resourcesRelease":[{"filterIDs":null,"tenant":""}],"*routes":[{"filterIDs":null,"tenant":""}],"*routesDerivedReply":[{"filterIDs":null,"tenant":""}],"*stats":[{"filterIDs":null,"tenant":""}],"*statsDerivedReply":[{"filterIDs":null,"tenant":""}],"*terminate":[{"filterIDs":null,"tenant":""}],"*thresholds":[{"filterIDs":null,"tenant":""}],"*thresholdsDerivedReply":[{"filterIDs":null,"tenant":""}],"*ttl":[{"filterIDs":null,"tenant":""}],"*ttlLastUsage":[],"*ttlLastUsed":[],"*ttlMaxDelay":[{"filterIDs":null,"tenant":""}],"*ttlUsage":[],"*update":[{"filterIDs":null,"tenant":""}]},"sessionIndexes":[],"stir":{"allowedAttest":["*any"],"defaultAttest":"A","payloadMaxduration":"-1","privateKeyPath":"","publicKeyPath":""},"storeSessionCosts":false,"terminateAttempts":5}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONFKamailioAgent(t *testing.T) {
	var reply string
	expected := `{"kamailioAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"createCDR":false,"enabled":false,"evapiConns":[{"address":"127.0.0.1:8448","alias":"","maxReconnectInterval":"0s","reconnects":5}],"timezone":""}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONARadiusAgent(t *testing.T) {
	var reply string
	expected := `{"radiusAgent":{"clientDaAddresses":{},"clientDictionaries":{"*default":["/usr/share/cgrates/radius/dict/"]},"clientSecrets":{"*default":"CGRateS.org"},"coaTemplate":"*coa","conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"dmrTemplate":"*dmr","enabled":false,"listeners":[{"acctAddress":"127.0.0.1:1813","authAddress":"127.0.0.1:1812","network":"udp"}],"requestProcessors":[],"requestsCacheKey":""}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONDNSAgent(t *testing.T) {
	var reply string
	expected := `{"dnsAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"enabled":false,"listeners":[{"address":"127.0.0.1:53","network":"udp"}],"requestProcessors":[],"timezone":""}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONAttributes(t *testing.T) {
	var reply string
	expected := `{"attributes":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*processRuns":[{"filterIDs":null,"tenant":""}],"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*profileRuns":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"suffixIndexedFields":[]}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONChargerS(t *testing.T) {
	var reply string
	expected := `{"chargers":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"prefixIndexedFields":[],"suffixIndexedFields":[]}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONResourceS(t *testing.T) {
	var reply string
	expected := `{"resources":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*units":[{"filterIDs":null,"tenant":""}],"*usageID":[{"filterIDs":null,"tenant":""}],"*usageTTL":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"storeInterval":"","suffixIndexedFields":[]}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONStatS(t *testing.T) {
	var reply string
	expected := `{"stats":{"conns":{},"eesExporterIDs":null,"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*roundingDecimals":[]},"prefixIndexedFields":[],"storeInterval":"","storeUncompressedLimit":0,"suffixIndexedFields":[]}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONThresholdS(t *testing.T) {
	var reply string
	expected := `{"thresholds":{"conns":{},"eesExporterIDs":[],"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"storeInterval":"","suffixIndexedFields":[]}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONSureTax(t *testing.T) {
	var reply string
	expected := `{"suretax":{"billToNumber":"","businessUnit":"","clientNumber":"","clientTracking":"~*opts.*originID","customerNumber":"~*req.Subject","includeLocalCost":false,"origNumber":"~*req.Subject","p2pplus4":"","p2pzipcode":"","plus4":"","regulatoryCode":"03","responseGroup":"03","responseType":"D4","returnFileCode":"0","salesTypeCode":"R","taxExemptionCodeList":"","taxIncluded":"0","taxSitusRule":"04","termNumber":"~*req.Destination","timezone":"UTC","transTypeCode":"010101","unitType":"00","units":"1","url":"","validationKey":"","zipcode":""}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONCgrLoader(t *testing.T) {
	var reply string
	expected := `{"loader":{"actionsConns":["*localhost"],"cachesConns":["*localhost"],"dataPath":"./","disableReverse":false,"fieldSeparator":",","gapiCredentials":".gapi/credentials.json","gapiToken":".gapi/token.json","tpid":""}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONCgrMigrator(t *testing.T) {
	var reply string
	expected := `{"migrator":{"fromItems":{"*accounts":{"dbConn":"*default"},"*chargerProfiles":{"dbConn":"*default"},"*filters":{"dbConn":"*default"},"*loadIDs":{"dbConn":"*default"},"*statQueueProfiles":{"dbConn":"*default"},"*versions":{"dbConn":"*default"}},"outDBOpts":{"mongoConnScheme":"mongodb","mongoQueryTimeout":"10s","redisCACertificate":"","redisClientCertificate":"","redisClientKey":"","redisCluster":false,"redisClusterOndownDelay":"0s","redisClusterSync":"5s","redisConnectAttempts":20,"redisConnectTimeout":"0s","redisMaxConns":10,"redisPoolPipelineLimit":0,"redisPoolPipelineWindow":"150µs","redisReadTimeout":"0s","redisSentinel":"","redisTLS":false,"redisWriteTimeout":"0s"},"usersFilters":null}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONSIPAgent(t *testing.T) {
	var reply string
	expected := `{"sipAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"enabled":false,"listen":"127.0.0.1:5060","listenNet":"udp","requestProcessors":[],"retransmissionTimer":"1s","timezone":""}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONConfigS(t *testing.T) {
	var reply string
	expected := `{"configs":{"enabled":false,"rootDir":"/var/spool/cgrates/configs","url":"/configs/"}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONAnalyzer(t *testing.T) {
	var reply string
	expected := `{"analyzers":{"cleanupInterval":"1h0m0s","conns":{},"dbPath":"/var/spool/cgrates/analyzers","enabled":false,"indexType":"*scorch","opts":{"*exporterIDs":[]},"ttl":"24h0m0s"}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONCoreS(t *testing.T) {
	var reply string
	expected := `{"cores":{"caps":10,"capsStatsInterval":"0","capsStrategy":"*busy","conns":{},"shutdownTimeout":"1s"}}`
	cgrCfg := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONAllConfig(t *testing.T) {
	...
	var reply string
	expected := `{"accounts":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"maxIterations":1000,"maxUsage":"259200000000000","nestedFields":false,"notExistsIndexedFields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*usage":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"suffixIndexedFields":[]},"actions":{"conns":{},"dynaprepaidActionProfile":[],"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*posterAttempts":[{"filterIDs":null,"tenant":""}],"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"suffixIndexedFields":[],"tenants":[]},"admins":{"conns":{"*caches":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"enabled":false},"analyzers":{"cleanupInterval":"1h0m0s","conns":{},"dbPath":"/var/spool/cgrates/analyzers","enabled":false,"indexType":"*scorch","opts":{"*exporterIDs":[]},"ttl":"24h0m0s"},"apiban":{"enabled":false,"keys":[]},"asteriskAgent":{"asteriskConns":[{"address":"127.0.0.1:8088","alias":"","ariWebsocket":false,"connectAttempts":3,"maxReconnectInterval":"0s","password":"CGRateS.org","reconnects":5,"user":"cgrates"}],"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"enabled":false,"requestProcessors":[]},"attributes":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*processRuns":[{"filterIDs":null,"tenant":""}],"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*profileRuns":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"suffixIndexedFields":[]},"caches":{"partitions":{"*accountFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*accounts":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*actionProfileFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*actionProfiles":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*apiban":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"2m0s"},"*attributeFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*attributeProfiles":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*capsEvents":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*cdrIDs":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"10m0s"},"*chargerFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*chargerProfiles":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*closedSessions":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"10s"},"*diameterMessages":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"3h0m0s"},"*eventCharges":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"10s"},"*eventIPs":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*eventResources":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*filters":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*ipAllocations":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*ipFilterIndexes":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*ipProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*loadIDs":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*radiusPackets":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"3h0m0s"},"*rankingProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*rankings":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*rateFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*rateProfileFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*rateProfiles":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*replicationHosts":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*resourceFilterIndexes":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*resourceProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*resources":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*reverseFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*routeFilterIndexes":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*routeProfiles":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*rpcConnections":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*rpcResponses":{"limit":0,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"2s"},"*sentrypeer":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":true,"ttl":"24h0m0s"},"*statFilterIndexes":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*statQueueProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*statQueues":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*stir":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"3h0m0s"},"*thresholdFilterIndexes":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*thresholdProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*thresholds":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*trendProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*trends":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false},"*uch":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"3h0m0s"}},"remoteConns":[],"replicationConns":[]},"cdrs":{"conns":{},"enabled":false,"extraFields":[],"onlineCDRExports":null,"opts":{"*accounts":[{"filterIDs":null,"tenant":""}],"*attributes":[{"filterIDs":null,"tenant":""}],"*chargers":[{"filterIDs":null,"tenant":""}],"*ees":[{"filterIDs":null,"tenant":""}],"*rates":[{"filterIDs":null,"tenant":""}],"*refund":[{"filterIDs":null,"tenant":""}],"*rerate":[{"filterIDs":null,"tenant":""}],"*stats":[{"filterIDs":null,"tenant":""}],"*store":[{"filterIDs":null,"tenant":""}],"*thresholds":[{"filterIDs":null,"tenant":""}]},"sessionCostRetries":5},"chargers":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"prefixIndexedFields":[],"suffixIndexedFields":[]},"configDB":{"dbHost":"","dbName":"","dbPassword":"","dbPort":0,"dbType":"*internal","dbUser":"","opts":{"internalDBBackupPath":"/var/lib/cgrates/internal_db/backup/configdb","internalDBDumpInterval":"0s","internalDBDumpPath":"/var/lib/cgrates/internal_db/configdb","internalDBFileSizeLimit":1073741824,"internalDBRewriteInterval":"0s","internalDBStartTimeout":"5m0s","mongoConnScheme":"mongodb","mongoQueryTimeout":"10s","redisBatchSize":1000,"redisCACertificate":"","redisClientCertificate":"","redisClientKey":"","redisCluster":false,"redisClusterOndownDelay":"0s","redisClusterSync":"5s","redisConnectAttempts":20,"redisConnectTimeout":"0s","redisMaxConns":10,"redisReadTimeout":"0s","redisSentinel":"","redisTLS":false,"redisWriteTimeout":"0s"}},"configs":{"enabled":false,"rootDir":"/var/spool/cgrates/configs","url":"/configs/"},"cores":{"caps":0,"capsStatsInterval":"0","capsStrategy":"*busy","conns":{},"shutdownTimeout":"1s"},"db":{"dbConns":{"*default":{"dbHost":"","dbName":"","dbPassword":"","dbPort":0,"dbType":"*internal","dbUser":"","opts":{"internalDBBackupPath":"/var/lib/cgrates/internal_db/backup/db","internalDBDumpInterval":"1m0s","internalDBDumpPath":"/var/lib/cgrates/internal_db/db","internalDBFileSizeLimit":1073741824,"internalDBRewriteInterval":"1h0m0s","internalDBStartTimeout":"5m0s","mongoConnScheme":"mongodb","mongoQueryTimeout":"10s","mysqlDSNParams":{},"mysqlLocation":"Local","pgSSLMode":"disable","redisBatchSize":1000,"redisCACertificate":"","redisClientCertificate":"","redisClientKey":"","redisCluster":false,"redisClusterOndownDelay":"0s","redisClusterSync":"5s","redisConnectAttempts":20,"redisConnectTimeout":"0s","redisMaxConns":10,"redisPoolPipelineLimit":0,"redisPoolPipelineWindow":"150µs","redisReadTimeout":"0s","redisSentinel":"","redisTLS":false,"redisWriteTimeout":"0s","sqlConnMaxLifetime":"0s","sqlLogLevel":3,"sqlMaxIdleConns":10,"sqlMaxOpenConns":100},"prefixIndexedFields":[],"remoteConnID":"","remoteConns":[],"replicationCache":"","replicationConns":[],"replicationFailedDir":"","replicationFiltered":false,"replicationInterval":"0s","stringIndexedFields":[]}},"items":{"*accountFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*accounts":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*actionProfileFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*actionProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*attributeFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*attributeProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*cdrs":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*chargerFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*chargerProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*filters":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*ipAllocations":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*ipFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*ipProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*loadIDs":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*rankingProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*rankings":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*rateFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*rateProfileFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*rateProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*resourceFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*resourceProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*resources":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*reverseFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*routeFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*routeProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*statFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*statQueueProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*statQueues":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*thresholdFilterIndexes":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*thresholdProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*thresholds":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*trendProfiles":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*trends":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false},"*versions":{"dbConn":"*default","limit":-1,"remote":false,"replicate":false,"staticTTL":false}}},"diameterAgent":{"asrTemplate":"","connHealthCheckInterval":"0s","connStatusStatQueueIDs":[],"connStatusThresholdIDs":[],"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"dictionariesAppendDefaults":true,"dictionariesPath":"/usr/share/cgrates/diameter/dict/","enabled":false,"forcedDisconnect":"*none","listeners":[{"address":"127.0.0.1:3868","network":"tcp"}],"originHost":"CGR-DA","originRealm":"cgrates.org","productName":"CGRateS","rarTemplate":"","requestProcessors":[],"syncedConnRequests":false,"vendorID":0},"dnsAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"enabled":false,"listeners":[{"address":"127.0.0.1:53","network":"udp"}],"requestProcessors":[],"timezone":""},"ees":{"cache":{"*fileCSV":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"}},"conns":{},"enabled":false,"exporters":[{"attempts":1,"attributeContext":"","attributeIDs":[],"blocker":false,"concurrentRequests":0,"conns":{"*efs":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"exportPath":"/var/spool/cgrates/ees","failedPostsDir":"/var/spool/cgrates/failed_posts","fields":[],"filters":[],"flags":[],"id":"*default","metricsResetSchedule":"","opts":{},"synchronous":false,"timezone":"","type":"*none"}]},"efs":{"enabled":false,"failedPostsDir":"/var/spool/cgrates/failed_posts","failedPostsStaticTTL":true,"failedPostsTTL":"5s","posterAttempts":3},"ers":{"conns":{},"enabled":false,"partialCacheTTL":"1s","readers":[{"cacheDumpFields":[],"concurrentRequests":1024,"eesFailedIDs":[],"eesSuccessIDs":[],"fields":[{"mandatory":true,"path":"*cgreq.ToR","tag":"ToR","type":"*variable","value":"~*req.2"},{"mandatory":true,"path":"*cgreq.OriginID","tag":"OriginID","type":"*variable","value":"~*req.3"},{"mandatory":true,"path":"*cgreq.RequestType","tag":"RequestType","type":"*variable","value":"~*req.4"},{"mandatory":true,"path":"*cgreq.Tenant","tag":"Tenant","type":"*variable","value":"~*req.6"},{"mandatory":true,"path":"*cgreq.Category","tag":"Category","type":"*variable","value":"~*req.7"},{"mandatory":true,"path":"*cgreq.Account","tag":"Account","type":"*variable","value":"~*req.8"},{"mandatory":true,"path":"*cgreq.Subject","tag":"Subject","type":"*variable","value":"~*req.9"},{"mandatory":true,"path":"*cgreq.Destination","tag":"Destination","type":"*variable","value":"~*req.10"},{"mandatory":true,"path":"*cgreq.SetupTime","tag":"SetupTime","type":"*variable","value":"~*req.11"},{"mandatory":true,"path":"*cgreq.AnswerTime","tag":"AnswerTime","type":"*variable","value":"~*req.12"},{"mandatory":true,"path":"*cgreq.Usage","tag":"Usage","type":"*variable","value":"~*req.13"}],"filters":[],"flags":[],"id":"*default","maxReconnectInterval":"5m0s","opts":{"csvFieldSeparator":",","csvHeaderDefineChar":":","csvRowLength":0,"natsSubject":"cgratesCDRs","partialCacheAction":"*none","partialOrderField":"~*req.AnswerTime"},"partialCommitFields":[],"processedPath":"/var/spool/cgrates/ers/out","reconnects":-1,"runDelay":"0","sourcePath":"/var/spool/cgrates/ers/in","startDelay":"0","tenant":"","timezone":"","type":"*none"}]},"filters":{"conns":{}},"freeswitchAgent":{"activeSessionDelimiter":",","conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"emptyBalanceAnnFile":"","emptyBalanceContext":"","enabled":false,"eventSocketConns":[{"address":"127.0.0.1:8021","alias":"127.0.0.1:8021","maxReconnectInterval":"0s","password":"ClueCon","reconnects":5,"replyTimeout":"1m0s"}],"extraFields":[],"lowBalanceAnnFile":"","maxWaitConnection":"2s","requestProcessors":[],"subscribePark":true},"general":{"cachingDelay":"0","connectAttempts":5,"connectTimeout":"1s","dbDataEncoding":"*msgpack","decimalMaxScale":0,"decimalMinScale":0,"decimalPrecision":0,"decimalRoundingMode":"*toNearestEven","defaultCaching":"*reload","defaultCategory":"call","defaultRequestType":"*rated","defaultTenant":"cgrates.org","defaultTimezone":"Local","digestEqual":":","digestSeparator":",","lockingTimeout":"0","maxParallelConns":100,"maxReconnectInterval":"0","nodeID":"ENGINE1","opts":{"*exporterIDs":[]},"reconnects":-1,"replyTimeout":"2s","roundingDecimals":5,"tpExportDir":"/var/spool/cgrates/tpe"},"http":{"authUsers":{},"clientOpts":{"dialFallbackDelay":"300ms","dialKeepAlive":"30s","dialTimeout":"30s","disableCompression":false,"disableKeepAlives":false,"expectContinueTimeout":"0s","forceAttemptHttp2":true,"idleConnTimeout":"1m30s","maxConnsPerHost":0,"maxIdleConns":100,"maxIdleConnsPerHost":2,"responseHeaderTimeout":"0s","skipTLSVerification":false,"tlsHandshakeTimeout":"10s"},"freeswitchCDRsURL":"/freeswitch_json","httpCDRs":"/cdr_http","jsonRPCurl":"/jsonrpc","pprofPath":"/debug/pprof/","registrarsURL":"/registrar","useBasicAuth":false,"wsURL":"/ws"},"httpAgent":[],"ips":{"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*allocationID":[{"filterIDs":null,"tenant":""}],"*ttl":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"storeInterval":"0s","stringIndexedFields":null,"suffixIndexedFields":[]},"janusAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"enabled":false,"janusConns":[{"address":"127.0.0.1:8088","adminAddress":"localhost:7188","adminPassword":"","type":"*ws"}],"requestProcessors":[],"url":"/janus"},"kamailioAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"createCDR":false,"enabled":false,"evapiConns":[{"address":"127.0.0.1:8448","alias":"","maxReconnectInterval":"0s","reconnects":5}],"timezone":""},"listen":{"http":"127.0.0.1:2080","httpTLS":"127.0.0.1:2280","rpcGOB":"127.0.0.1:2013","rpcGOBtls":"127.0.0.1:2023","rpcJSON":"127.0.0.1:2012","rpcJSONtls":"127.0.0.1:2022"},"loader":{"actionsConns":["*localhost"],"cachesConns":["*localhost"],"dataPath":"./","disableReverse":false,"fieldSeparator":",","gapiCredentials":".gapi/credentials.json","gapiToken":".gapi/token.json","tpid":""},"loaders":[{"action":"*store","cache":{"*accounts":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*actionProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*attributes":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*chargers":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*filters":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*ips":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*rankings":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*rateProfiles":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*resources":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*routes":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*stats":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*thresholds":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"},"*trends":{"limit":-1,"precache":false,"remote":false,"replicate":false,"staticTTL":false,"ttl":"5s"}},"conns":{"*caches":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"data":[{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"newBranch":true,"path":"Rules.Type","tag":"Type","type":"*variable","value":"~*req.2"},{"path":"Rules.Element","tag":"Element","type":"*variable","value":"~*req.3"},{"path":"Rules.Values","tag":"Values","type":"*variable","value":"~*req.4"}],"fileName":"Filters.csv","flags":null,"type":"*filters"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"TenantID","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ProfileID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"Blockers","tag":"Blockers","type":"*variable","value":"~*req.4"},{"newBranch":true,"path":"Attributes.FilterIDs","tag":"AttributeFilterIDs","type":"*variable","value":"~*req.5"},{"path":"Attributes.Blockers","tag":"AttributeBlockers","type":"*variable","value":"~*req.6"},{"path":"Attributes.Path","tag":"Path","type":"*variable","value":"~*req.7"},{"path":"Attributes.Type","tag":"Type","type":"*variable","value":"~*req.8"},{"path":"Attributes.Value","tag":"Value","type":"*variable","value":"~*req.9"}],"fileName":"Attributes.csv","flags":null,"type":"*attributes"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"UsageTTL","tag":"TTL","type":"*variable","value":"~*req.4"},{"path":"Limit","tag":"Limit","type":"*variable","value":"~*req.5"},{"path":"AllocationMessage","tag":"AllocationMessage","type":"*variable","value":"~*req.6"},{"path":"Blocker","tag":"Blocker","type":"*variable","value":"~*req.7"},{"path":"Stored","tag":"Stored","type":"*variable","value":"~*req.8"},{"path":"ThresholdIDs","tag":"ThresholdIDs","type":"*variable","value":"~*req.9"}],"fileName":"Resources.csv","flags":null,"type":"*resources"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"TTL","tag":"TTL","type":"*variable","value":"~*req.4"},{"path":"Stored","tag":"Stored","type":"*variable","value":"~*req.5"},{"newBranch":true,"path":"Pools.ID","tag":"PoolID","type":"*variable","value":"~*req.6"},{"path":"Pools.FilterIDs","tag":"PoolFilterIDs","type":"*variable","value":"~*req.7"},{"path":"Pools.Type","tag":"PoolType","type":"*variable","value":"~*req.8"},{"path":"Pools.Range","tag":"PoolRange","type":"*variable","value":"~*req.9"},{"path":"Pools.Strategy","tag":"PoolStrategy","type":"*variable","value":"~*req.10"},{"path":"Pools.Message","tag":"PoolMessage","type":"*variable","value":"~*req.11"},{"path":"Pools.Weights","tag":"PoolWeights","type":"*variable","value":"~*req.12"},{"path":"Pools.Blockers","tag":"PoolBlockers","type":"*variable","value":"~*req.13"}],"fileName":"IPs.csv","flags":null,"type":"*ips"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"Blockers","tag":"Blockers","type":"*variable","value":"~*req.4"},{"path":"QueueLength","tag":"QueueLength","type":"*variable","value":"~*req.5"},{"path":"TTL","tag":"TTL","type":"*variable","value":"~*req.6"},{"path":"MinItems","tag":"MinItems","type":"*variable","value":"~*req.7"},{"path":"Stored","tag":"Stored","type":"*variable","value":"~*req.8"},{"path":"ThresholdIDs","tag":"ThresholdIDs","type":"*variable","value":"~*req.9"},{"newBranch":true,"path":"Metrics.MetricID","tag":"MetricIDs","type":"*variable","value":"~*req.10"},{"path":"Metrics.FilterIDs","tag":"MetricFilterIDs","type":"*variable","value":"~*req.11"},{"path":"Metrics.Blockers","tag":"MetricBlockers","type":"*variable","value":"~*req.12"}],"fileName":"Stats.csv","flags":null,"type":"*stats"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"MaxHits","tag":"MaxHits","type":"*variable","value":"~*req.4"},{"path":"MinHits","tag":"MinHits","type":"*variable","value":"~*req.5"},{"path":"MinSleep","tag":"MinSleep","type":"*variable","value":"~*req.6"},{"path":"Blocker","tag":"Blocker","type":"*variable","value":"~*req.7"},{"path":"AttributeIDs","tag":"AttributeIDs","type":"*variable","value":"~*req.8"},{"path":"ActionProfileIDs","tag":"ActionProfileIDs","type":"*variable","value":"~*req.9"},{"path":"Async","tag":"Async","type":"*variable","value":"~*req.10"},{"path":"EeIDs","tag":"EeIDs","type":"*variable","value":"~*req.11"}],"fileName":"Thresholds.csv","flags":null,"type":"*thresholds"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"Schedule","tag":"Schedule","type":"*variable","value":"~*req.2"},{"path":"StatID","tag":"StatID","type":"*variable","value":"~*req.3"},{"path":"Metrics","tag":"Metrics","type":"*variable","value":"~*req.4"},{"path":"TTL","tag":"TTL","type":"*variable","value":"~*req.5"},{"path":"QueueLength","tag":"QueueLength","type":"*variable","value":"~*req.6"},{"path":"MinItems","tag":"MinItems","type":"*variable","value":"~*req.7"},{"path":"CorrelationType","tag":"CorrelationType","type":"*variable","value":"~*req.8"},{"path":"Tolerance","tag":"Tolerance","type":"*variable","value":"~*req.9"},{"path":"Stored","tag":"Stored","type":"*variable","value":"~*req.10"},{"path":"ThresholdIDs","tag":"ThresholdIDs","type":"*variable","value":"~*req.11"}],"fileName":"Trends.csv","flags":null,"type":"*trends"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"Schedule","tag":"Schedule","type":"*variable","value":"~*req.2"},{"path":"StatIDs","tag":"StatIDs","type":"*variable","value":"~*req.3"},{"path":"MetricIDs","tag":"MetricIDs","type":"*variable","value":"~*req.4"},{"path":"Sorting","tag":"Sorting","type":"*variable","value":"~*req.5"},{"path":"SortingParameters","tag":"SortingParameters","type":"*variable","value":"~*req.6"},{"path":"Stored","tag":"Stored","type":"*variable","value":"~*req.7"},{"path":"ThresholdIDs","tag":"ThresholdIDs","type":"*variable","value":"~*req.8"}],"fileName":"Rankings.csv","flags":null,"type":"*rankings"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"Blockers","tag":"Blockers","type":"*variable","value":"~*req.4"},{"path":"Sorting","tag":"Sorting","type":"*variable","value":"~*req.5"},{"path":"SortingParameters","tag":"SortingParameters","type":"*variable","value":"~*req.6"},{"newBranch":true,"path":"Routes.ID","tag":"RouteID","type":"*variable","value":"~*req.7"},{"path":"Routes.FilterIDs","tag":"RouteFilterIDs","type":"*variable","value":"~*req.8"},{"path":"Routes.AccountIDs","tag":"RouteAccountIDs","type":"*variable","value":"~*req.9"},{"path":"Routes.RateProfileIDs","tag":"RouteRateProfileIDs","type":"*variable","value":"~*req.10"},{"path":"Routes.ResourceIDs","tag":"RouteResourceIDs","type":"*variable","value":"~*req.11"},{"path":"Routes.StatIDs","tag":"RouteStatIDs","type":"*variable","value":"~*req.12"},{"path":"Routes.Weights","tag":"RouteWeights","type":"*variable","value":"~*req.13"},{"path":"Routes.Blockers","tag":"RouteBlockers","type":"*variable","value":"~*req.14"},{"path":"Routes.RouteParameters","tag":"RouteParameters","type":"*variable","value":"~*req.15"}],"fileName":"Routes.csv","flags":null,"type":"*routes"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"Blockers","tag":"Blockers","type":"*variable","value":"~*req.4"},{"path":"RunID","tag":"RunID","type":"*variable","value":"~*req.5"},{"path":"AttributeIDs","tag":"AttributeIDs","type":"*variable","value":"~*req.6"}],"fileName":"Chargers.csv","flags":null,"type":"*chargers"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"MinCost","tag":"MinCost","type":"*variable","value":"~*req.4"},{"path":"MaxCost","tag":"MaxCost","type":"*variable","value":"~*req.5"},{"path":"MaxCostStrategy","tag":"MaxCostStrategy","type":"*variable","value":"~*req.6"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].FilterIDs","tag":"RateFilterIDs","type":"*variable","value":"~*req.8"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].ActivationTimes","tag":"RateActivationTimes","type":"*variable","value":"~*req.9"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].Weights","tag":"RateWeights","type":"*variable","value":"~*req.10"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].Blocker","tag":"RateBlocker","type":"*variable","value":"~*req.11"},{"filters":["*notempty:~*req.7:"],"newBranch":true,"path":"Rates[\u003c~*req.7\u003e].IntervalRates.IntervalStart","tag":"RateIntervalStart","type":"*variable","value":"~*req.12"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].IntervalRates.FixedFee","tag":"RateFixedFee","type":"*variable","value":"~*req.13"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].IntervalRates.RecurrentFee","tag":"RateRecurrentFee","type":"*variable","value":"~*req.14"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].IntervalRates.Unit","tag":"RateUnit","type":"*variable","value":"~*req.15"},{"filters":["*notempty:~*req.7:"],"path":"Rates[\u003c~*req.7\u003e].IntervalRates.Increment","tag":"RateIncrement","type":"*variable","value":"~*req.16"}],"fileName":"Rates.csv","flags":null,"type":"*rateProfiles"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"Blockers","tag":"Blockers","type":"*variable","value":"~*req.4"},{"path":"Schedule","tag":"Schedule","type":"*variable","value":"~*req.5"},{"path":"Targets[\u003c~*req.6\u003e]","tag":"TargetIDs","type":"*variable","value":"~*req.7"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].FilterIDs","tag":"ActionFilterIDs","type":"*variable","value":"~*req.9"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].TTL","tag":"ActionTTL","type":"*variable","value":"~*req.10"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Type","tag":"ActionType","type":"*variable","value":"~*req.11"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Opts","tag":"ActionOpts","type":"*variable","value":"~*req.12"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Weights","tag":"ActionWeights","type":"*variable","value":"~*req.13"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Blockers","tag":"ActionBlockers","type":"*variable","value":"~*req.14"},{"filters":["*notempty:~*req.8:"],"newBranch":true,"path":"Actions[\u003c~*req.8\u003e].Diktats.ID","tag":"ActionDiktatsID","type":"*variable","value":"~*req.15"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Diktats.FilterIDs","tag":"ActionDiktatsFilterIDs","type":"*variable","value":"~*req.16"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Diktats.Opts","tag":"ActionDiktatsOpts","type":"*variable","value":"~*req.17"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Diktats.Weights","tag":"ActionDiktatsWeights","type":"*variable","value":"~*req.18"},{"filters":["*notempty:~*req.8:"],"path":"Actions[\u003c~*req.8\u003e].Diktats.Blockers","tag":"ActionDiktatsBlockers","type":"*variable","value":"~*req.19"}],"fileName":"Actions.csv","flags":null,"type":"*actionProfiles"},{"fields":[{"mandatory":true,"path":"Tenant","tag":"Tenant","type":"*variable","value":"~*req.0"},{"mandatory":true,"path":"ID","tag":"ID","type":"*variable","value":"~*req.1"},{"path":"FilterIDs","tag":"FilterIDs","type":"*variable","value":"~*req.2"},{"path":"Weights","tag":"Weights","type":"*variable","value":"~*req.3"},{"path":"Blockers","tag":"Blockers","type":"*variable","value":"~*req.4"},{"path":"Opts","tag":"Opts","type":"*variable","value":"~*req.5"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].FilterIDs","tag":"BalanceFilterIDs","type":"*variable","value":"~*req.7"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].Weights","tag":"BalanceWeights","type":"*variable","value":"~*req.8"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].Blockers","tag":"BalanceBlockers","type":"*variable","value":"~*req.9"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].Type","tag":"BalanceType","type":"*variable","value":"~*req.10"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].Units","tag":"BalanceUnits","type":"*variable","value":"~*req.11"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].UnitFactors","tag":"BalanceUnitFactors","type":"*variable","value":"~*req.12"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].Opts","tag":"BalanceOpts","type":"*variable","value":"~*req.13"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].CostIncrements","tag":"BalanceCostIncrements","type":"*variable","value":"~*req.14"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].AttributeIDs","tag":"BalanceAttributeIDs","type":"*variable","value":"~*req.15"},{"filters":["*notempty:~*req.6:"],"path":"Balances[\u003c~*req.6\u003e].RateProfileIDs","tag":"BalanceRateProfileIDs","type":"*variable","value":"~*req.16"},{"path":"ThresholdIDs","tag":"ThresholdIDs","type":"*variable","value":"~*req.17"}],"fileName":"Accounts.csv","flags":null,"type":"*accounts"}],"enabled":false,"fieldSeparator":",","id":"*default","lockfilePath":".cgr.lck","opts":{"*cache":"","*forceLock":false,"*stopOnError":false,"*withIndex":true},"runDelay":"0","tenant":"","tpInPath":"/var/spool/cgrates/loader/in","tpOutPath":""}],"logger":{"efsConns":["*internal"],"level":6,"opts":{"failedPostsDir":"/var/spool/cgrates/failed_posts","kafkaAttempts":1,"kafkaConn":"","kafkaTopic":""},"type":"*syslog"},"migrator":{"fromItems":{"*accounts":{"dbConn":"*default"},"*chargerProfiles":{"dbConn":"*default"},"*filters":{"dbConn":"*default"},"*loadIDs":{"dbConn":"*default"},"*statQueueProfiles":{"dbConn":"*default"},"*versions":{"dbConn":"*default"}},"outDBOpts":{"mongoConnScheme":"mongodb","mongoQueryTimeout":"10s","redisCACertificate":"","redisClientCertificate":"","redisClientKey":"","redisCluster":false,"redisClusterOndownDelay":"0s","redisClusterSync":"5s","redisConnectAttempts":20,"redisConnectTimeout":"0s","redisMaxConns":10,"redisPoolPipelineLimit":0,"redisPoolPipelineWindow":"150µs","redisReadTimeout":"0s","redisSentinel":"","redisTLS":false,"redisWriteTimeout":"0s"},"usersFilters":null},"prometheusAgent":{"cacheIDs":[],"collectGoMetrics":false,"collectProcessMetrics":false,"conns":{},"enabled":false,"path":"/prometheus","statQueueIDs":[]},"radiusAgent":{"clientDaAddresses":{},"clientDictionaries":{"*default":["/usr/share/cgrates/radius/dict/"]},"clientSecrets":{"*default":"CGRateS.org"},"coaTemplate":"*coa","conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"dmrTemplate":"*dmr","enabled":false,"listeners":[{"acctAddress":"127.0.0.1:1813","authAddress":"127.0.0.1:1812","network":"udp"}],"requestProcessors":[],"requestsCacheKey":""},"rankings":{"conns":{},"eesExporterIDs":null,"enabled":false,"scheduledIDs":{},"storeInterval":""},"rates":{"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*intervalStart":[{"filterIDs":null,"tenant":""}],"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*startTime":[{"filterIDs":null,"tenant":""}],"*usage":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"rateExistsIndexedFields":[],"rateIndexedSelects":true,"rateNestedFields":false,"rateNotExistsIndexedFields":[],"ratePrefixIndexedFields":[],"rateSuffixIndexedFields":[],"suffixIndexedFields":[],"verbosity":1000},"registrarc":{"rpc":{"hosts":[],"refreshInterval":"5m0s","registrarsConns":[]}},"resources":{"conns":{},"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*units":[{"filterIDs":null,"tenant":""}],"*usageID":[{"filterIDs":null,"tenant":""}],"*usageTTL":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"storeInterval":"","suffixIndexedFields":[]},"routes":{"conns":{},"defaultRatio":1,"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*context":[{"filterIDs":null,"tenant":""}],"*ignoreErrors":[{"filterIDs":null,"tenant":""}],"*limit":[],"*maxCost":[{"tenant":"","Value":""}],"*maxItems":[],"*offset":[],"*profileCount":[{"filterIDs":null,"tenant":""}],"*usage":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"suffixIndexedFields":[]},"rpcConns":{"*bijsonLocalhost":{"conns":[{"address":"127.0.0.1:2014","transport":"*birpc_json"}],"poolSize":0,"strategy":"*first"},"*birpc_internal":{"conns":[{"address":"*birpc_internal","transport":""}],"poolSize":0,"strategy":"*first"},"*internal":{"conns":[{"address":"*internal","transport":""}],"poolSize":0,"strategy":"*first"},"*localhost":{"conns":[{"address":"127.0.0.1:2012","transport":"*json"}],"poolSize":0,"strategy":"*first"}},"sentrypeer":{"audience":"https://sentrypeer.com/api","clientID":"","clientSecret":"","grantType":"clientCredentials","ipsUrl":"https://sentrypeer.com/api/ip-addresses","numbersUrl":"https://sentrypeer.com/api/phone-numbers","tokenUrl":"https://authz.sentrypeer.com/oauth/token"},"sessions":{"alterableFields":[],"channelSyncInterval":"0","clientProtocol":1,"conns":{},"defaultUsage":{"*any":"3h0m0s","*data":"1048576","*sms":"1","*voice":"3h0m0s"},"enabled":false,"listenBiGob":"","listenBiJSON":"127.0.0.1:2014","minDurLowBalance":"0","opts":{"*accounts":[{"filterIDs":null,"tenant":""}],"*accountsForceUsage":[],"*attributes":[{"filterIDs":null,"tenant":""}],"*attributesDerivedReply":[{"filterIDs":null,"tenant":""}],"*autoChargeInterval":[{"filterIDs":null,"tenant":""}],"*blockerError":[{"filterIDs":null,"tenant":""}],"*cdrs":[{"filterIDs":null,"tenant":""}],"*cdrsDerivedReply":[{"filterIDs":null,"tenant":""}],"*chargeable":[{"filterIDs":null,"tenant":""}],"*chargers":[{"filterIDs":null,"tenant":""}],"*ees":[],"*eesIDs":[],"*forceUsage":[],"*initiate":[{"filterIDs":null,"tenant":""}],"*ips":[{"filterIDs":null,"tenant":""}],"*ipsAllocate":[{"filterIDs":null,"tenant":""}],"*ipsAuthorize":[{"filterIDs":null,"tenant":""}],"*ipsRelease":[{"filterIDs":null,"tenant":""}],"*maxUsage":[{"filterIDs":null,"tenant":""}],"*message":[{"filterIDs":null,"tenant":""}],"*originID":[],"*rates":[{"filterIDs":null,"tenant":""}],"*resources":[{"filterIDs":null,"tenant":""}],"*resourcesAllocate":[{"filterIDs":null,"tenant":""}],"*resourcesAuthorize":[{"filterIDs":null,"tenant":""}],"*resourcesDerivedReply":[{"filterIDs":null,"tenant":""}],"*resourcesRelease":[{"filterIDs":null,"tenant":""}],"*routes":[{"filterIDs":null,"tenant":""}],"*routesDerivedReply":[{"filterIDs":null,"tenant":""}],"*stats":[{"filterIDs":null,"tenant":""}],"*statsDerivedReply":[{"filterIDs":null,"tenant":""}],"*terminate":[{"filterIDs":null,"tenant":""}],"*thresholds":[{"filterIDs":null,"tenant":""}],"*thresholdsDerivedReply":[{"filterIDs":null,"tenant":""}],"*ttl":[{"filterIDs":null,"tenant":""}],"*ttlLastUsage":[],"*ttlLastUsed":[],"*ttlMaxDelay":[{"filterIDs":null,"tenant":""}],"*ttlUsage":[],"*update":[{"filterIDs":null,"tenant":""}]},"sessionIndexes":[],"stir":{"allowedAttest":["*any"],"defaultAttest":"A","payloadMaxduration":"-1","privateKeyPath":"","publicKeyPath":""},"storeSessionCosts":false,"terminateAttempts":5},"sipAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*internal"]}]},"enabled":false,"listen":"127.0.0.1:5060","listenNet":"udp","requestProcessors":[],"retransmissionTimer":"1s","timezone":""},"stats":{"conns":{},"eesExporterIDs":null,"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}],"*roundingDecimals":[]},"prefixIndexedFields":[],"storeInterval":"","storeUncompressedLimit":0,"suffixIndexedFields":[]},"suretax":{"billToNumber":"","businessUnit":"","clientNumber":"","clientTracking":"~*opts.*originID","customerNumber":"~*req.Subject","includeLocalCost":false,"origNumber":"~*req.Subject","p2pplus4":"","p2pzipcode":"","plus4":"","regulatoryCode":"03","responseGroup":"03","responseType":"D4","returnFileCode":"0","salesTypeCode":"R","taxExemptionCodeList":"","taxIncluded":"0","taxSitusRule":"04","termNumber":"~*req.Destination","timezone":"UTC","transTypeCode":"010101","unitType":"00","units":"1","url":"","validationKey":"","zipcode":""},"templates":{"*asr":[{"mandatory":true,"path":"*diamreq.Session-Id","tag":"SessionId","type":"*variable","value":"~*req.Session-Id"},{"mandatory":true,"path":"*diamreq.Origin-Host","tag":"OriginHost","type":"*variable","value":"~*req.Destination-Host"},{"mandatory":true,"path":"*diamreq.Origin-Realm","tag":"OriginRealm","type":"*variable","value":"~*req.Destination-Realm"},{"mandatory":true,"path":"*diamreq.Destination-Realm","tag":"DestinationRealm","type":"*variable","value":"~*req.Origin-Realm"},{"mandatory":true,"path":"*diamreq.Destination-Host","tag":"DestinationHost","type":"*variable","value":"~*req.Origin-Host"},{"mandatory":true,"path":"*diamreq.Auth-Application-Id","tag":"AuthApplicationId","type":"*variable","value":"~*vars.*appid"}],"*astr":[{"path":"*cgreq.ToR","tag":"ToR","type":"*constant","value":"*voice"},{"path":"*cgreq.OriginID","tag":"OriginID","type":"*variable","value":"~*req.channel.id"},{"path":"*opts.*originID","tag":"originID","type":"*variable","value":"~*req.channel.id"},{"path":"*cgreq.OriginHost","tag":"OriginHost","type":"*variable","value":"~*vars.OriginHost"},{"path":"*cgreq.RequestType","tag":"RequestType","type":"*constant","value":"*prepaid"},{"path":"*cgreq.Tenant","tag":"Tenant","type":"*constant","value":"cgrates.org"},{"path":"*cgreq.Account","tag":"Account","type":"*variable","value":"~*req.channel.caller.number"},{"path":"*cgreq.Subject","tag":"Subject","type":"*variable","value":"~*req.channel.caller.number"},{"path":"*cgreq.Destination","tag":"Destination","type":"*variable","value":"~*req.channel.dialplan.exten"},{"path":"*cgreq.SetupTime","tag":"SetupTime","type":"*variable","value":"~*req.channel.creationtime"},{"path":"*cgreq.Cost","tag":"Cost","type":"*constant","value":"-1.0"}],"*cca":[{"mandatory":true,"path":"*rep.Session-Id","tag":"SessionId","type":"*variable","value":"~*req.Session-Id"},{"path":"*rep.Result-Code","tag":"ResultCode","type":"*constant","value":"2001"},{"mandatory":true,"path":"*rep.Origin-Host","tag":"OriginHost","type":"*variable","value":"~*vars.OriginHost"},{"mandatory":true,"path":"*rep.Origin-Realm","tag":"OriginRealm","type":"*variable","value":"~*vars.OriginRealm"},{"mandatory":true,"path":"*rep.Auth-Application-Id","tag":"AuthApplicationId","type":"*variable","value":"~*vars.*appid"},{"mandatory":true,"path":"*rep.CC-Request-Type","tag":"CCRequestType","type":"*variable","value":"~*req.CC-Request-Type"},{"mandatory":true,"path":"*rep.CC-Request-Number","tag":"CCRequestNumber","type":"*variable","value":"~*req.CC-Request-Number"}],"*cdrLog":[{"mandatory":true,"path":"*cdr.ToR","tag":"ToR","type":"*variable","value":"~*req.BalanceType"},{"mandatory":true,"path":"*cdr.OriginHost","tag":"OriginHost","type":"*constant","value":"127.0.0.1"},{"mandatory":true,"path":"*cdr.RequestType","tag":"RequestType","type":"*constant","value":"*none"},{"mandatory":true,"path":"*cdr.Tenant","tag":"Tenant","type":"*variable","value":"~*req.Tenant"},{"mandatory":true,"path":"*cdr.Account","tag":"Account","type":"*variable","value":"~*req.Account"},{"mandatory":true,"path":"*cdr.Subject","tag":"Subject","type":"*variable","value":"~*req.Account"},{"mandatory":true,"path":"*cdr.Cost","tag":"Cost","type":"*variable","value":"~*req.Cost"},{"mandatory":true,"path":"*cdr.Source","tag":"Source","type":"*constant","value":"*cdrLog"},{"mandatory":true,"path":"*cdr.Usage","tag":"Usage","type":"*constant","value":"1"},{"mandatory":true,"path":"*cdr.RunID","tag":"RunID","type":"*variable","value":"~*req.ActionType"},{"mandatory":true,"path":"*cdr.SetupTime","tag":"SetupTime","type":"*constant","value":"*now"},{"mandatory":true,"path":"*cdr.AnswerTime","tag":"AnswerTime","type":"*constant","value":"*now"},{"mandatory":true,"path":"*cdr.PreRated","tag":"PreRated","type":"*constant","value":"true"}],"*coa":[{"path":"*radDAReq.User-Name","tag":"User-Name","type":"*variable","value":"~*oreq.User-Name"},{"path":"*radDAReq.NAS-IP-Address","tag":"NAS-IP-Address","type":"*variable","value":"~*oreq.NAS-IP-Address"},{"path":"*radDAReq.Acct-Session-Id","tag":"Acct-Session-Id","type":"*variable","value":"~*oreq.Acct-Session-Id"},{"path":"*radDAReq.Filter-Id","tag":"Filter-Id","type":"*variable","value":"~*req.CustomFilter"}],"*dmr":[{"path":"*radDAReq.User-Name","tag":"User-Name","type":"*variable","value":"~*oreq.User-Name"},{"path":"*radDAReq.NAS-IP-Address","tag":"NAS-IP-Address","type":"*variable","value":"~*oreq.NAS-IP-Address"},{"path":"*radDAReq.Acct-Session-Id","tag":"Acct-Session-Id","type":"*variable","value":"~*oreq.Acct-Session-Id"},{"path":"*radDAReq.Reply-Message","tag":"Reply-Message","type":"*variable","value":"~*req.DisconnectCause"}],"*err":[{"mandatory":true,"path":"*rep.Session-Id","tag":"SessionId","type":"*variable","value":"~*req.Session-Id"},{"mandatory":true,"path":"*rep.Origin-Host","tag":"OriginHost","type":"*variable","value":"~*vars.OriginHost"},{"mandatory":true,"path":"*rep.Origin-Realm","tag":"OriginRealm","type":"*variable","value":"~*vars.OriginRealm"}],"*errSip":[{"mandatory":true,"path":"*rep.Request","tag":"Request","type":"*constant","value":"SIP/2.0 500 Internal Server Error"}],"*fsr":[{"path":"*cgreq.ToR","tag":"ToR","type":"*constant","value":"*voice"},{"path":"*cgreq.PDD","tag":"PDD","type":"*composed","value":"~*req.variable_progress_mediamsec;ms"},{"path":"*cgreq.ACD","tag":"ACD","type":"*composed","value":"~*req.variable_cgrAcd;s"},{"path":"*cgreq.OriginID","tag":"OriginID","type":"*variable","value":"~*req.Unique-ID"},{"path":"*opts.*originID","tag":"*originID","type":"*variable","value":"~*req.Unique-ID"},{"path":"*cgreq.OriginHost","tag":"OriginHost","type":"*variable","value":"~*vars.Originhost"},{"path":"*cgreq.Account","tag":"Account","type":"*variable","value":"~*req.Caller-Username"},{"path":"*cgreq.Source","tag":"Source","type":"*composed","value":"FS_;~*req.Event-Name"},{"filters":["*string:*req.variable_process_cdr:false"],"path":"*cgreq.RequestType","tag":"RequestType","type":"*constant","value":"*none"},{"filters":["*string:*req.Caller-Dialplan:inline"],"path":"*cgreq.RequestType","tag":"RequestType","type":"*constant","value":"*none"},{"filters":["*exists:*cgreq.RequestType:"],"path":"*cgreq.RequestType","tag":"RequestType","type":"*constant","value":"*prepaid"},{"path":"*cgreq.Tenant","tag":"Tenant","type":"*constant","value":"cgrates.org"},{"path":"*cgreq.Category","tag":"Category","type":"*constant","value":"call"},{"path":"*cgreq.Subject","tag":"Subject","type":"*variable","value":"~*req.Caller-Username"},{"path":"*cgreq.Destination","tag":"Destination","type":"*variable","value":"~*req.Caller-Destination-Number"},{"path":"*cgreq.SetupTime","tag":"SetupTime","type":"*variable","value":"~*req.Caller-Channel-Created-Time"},{"path":"*cgreq.AnswerTime","tag":"AnswerTime","type":"*variable","value":"~*req.Caller-Channel-Answered-Time"},{"path":"*cgreq.Usage","tag":"Usage","type":"*composed","value":"~*req.variable_billsec;s"},{"path":"*cgreq.Route","tag":"Route","type":"*variable","value":"~*req.variable_cgrRoute"},{"path":"*cgreq.Cost","tag":"Cost","type":"*constant","value":"-1.0"},{"filters":["*notempty:*req.Hangup-Cause:"],"path":"*cgreq.DisconnectCause","tag":"DisconnectCause","type":"*variable","value":"~*req.Hangup-Cause"}],"*rar":[{"mandatory":true,"path":"*diamreq.Session-Id","tag":"SessionId","type":"*variable","value":"~*req.Session-Id"},{"mandatory":true,"path":"*diamreq.Origin-Host","tag":"OriginHost","type":"*variable","value":"~*req.Destination-Host"},{"mandatory":true,"path":"*diamreq.Origin-Realm","tag":"OriginRealm","type":"*variable","value":"~*req.Destination-Realm"},{"mandatory":true,"path":"*diamreq.Destination-Realm","tag":"DestinationRealm","type":"*variable","value":"~*req.Origin-Realm"},{"mandatory":true,"path":"*diamreq.Destination-Host","tag":"DestinationHost","type":"*variable","value":"~*req.Origin-Host"},{"mandatory":true,"path":"*diamreq.Auth-Application-Id","tag":"AuthApplicationId","type":"*variable","value":"~*vars.*appid"},{"path":"*diamreq.Re-Auth-Request-Type","tag":"ReAuthRequestType","type":"*constant","value":"0"}]},"thresholds":{"conns":{},"eesExporterIDs":[],"enabled":false,"existsIndexedFields":[],"indexedSelects":true,"nestedFields":false,"notExistsIndexedFields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"filterIDs":null,"tenant":""}]},"prefixIndexedFields":[],"storeInterval":"","suffixIndexedFields":[]},"tls":{"caCertificate":"","clientCertificate":"","clientKey":"","serverCertificate":"","serverKey":"","serverName":"","serverPolicy":4},"tpes":{"enabled":false},"trends":{"conns":{},"eesExporterIDs":null,"enabled":false,"scheduledIDs":{},"storeInterval":"","storeUncompressedLimit":0}}`
...
func TestLoadConfigFromReaderLoadFunctionsError(t *testing.T) {
	...
	expected := `json: cannot unmarshal number into Go struct field DbConnJson.dbConns.dbType of type string`
	cgrCfg := NewDefaultCGRConfig()
...
func TestLoadActionSCfgError(t *testing.T) {
	...
	expected := "json: cannot unmarshal string into Go struct field ActionSJsonCfg.stringIndexedFields of type []string"
	cgrConfig := NewDefaultCGRConfig()
...
"ips": {
	...
	"indexedSelects": true,
	"storeInterval": "-1",
	"stringIndexedFields": ["*req.Account", "*req.Destination"],
	"prefixIndexedFields": ["*req.Prefix"],
	"nestedFields": false
}
}`
