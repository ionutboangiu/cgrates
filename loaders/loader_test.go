...
func TestSetToDB(t *testing.T) {
	...
	v2 := &utils.ResourceProfile{Tenant: "cgrates.org", ID: "ID"}
	...
	v5 := &utils.ChargerProfile{Tenant: "cgrates.org", ID: "ID"}
	...
	v7 := &utils.ActionProfile{Tenant: "cgrates.org", ID: "ID", Targets: map[string]utils.StringSet{}}
...
func TestLoaderProcessCallCahe(t *testing.T) {
	...
	{
		v := &utils.ResourceProfile{Tenant: "cgrates.org", ID: "ID"}
	...
	{
		v := &utils.ChargerProfile{Tenant: "cgrates.org", ID: "ID"}
	...
	{
		v := &utils.ActionProfile{Tenant: "cgrates.org", ID: "ID", Targets: map[string]utils.StringSet{}}
