...
cgrates.org,sms,1001,2014-01-14T00:00:00Z,RP_ANY,`,
		utils.StatsCsv: `#Tenant[0],Id[1],FilterIDs[2],ActivationInterval[3],QueueLength[4],TTL[5],MinItems[6],StatID[7],Metrics[8],MetricFilterIDs[9],Stored[10],Blocker[11],Weight[12],ThresholdIDs[13]
cgrates.org,STATS_CALL_DUR,*string:~*req.RunID:*default,,,-1,,,,,,,,
cgrates.org,STATS_CALL_DUR,,,,,,total_calls,*tcd;*acc;*tcc;*sum#1,,,,,*none
cgrates.org,STATS_CALL_DUR,,,,,,short_calls,*tcd;*acc;*tcc;*sum#1,*lte:~*req.Usage:6s,,,,*none`,
	}
